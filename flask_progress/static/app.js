...
d3.select("#submit-btn").on("click", function() {
  ...
  $.ajax(`http://localhost:5000/api/predict?avgGlucose=${glucoseInput}&BMI=${bmiInput}&Age=${ageInput}&EverMarried_Yes=${marriageInput2}&ResidenceType_Urban=${residenceInput2}&Gender_Male=${genderInput2}`).done(function (response) {
